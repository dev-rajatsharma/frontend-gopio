...
export default class ContactUs extends React.Component {
    ...
    handleSubmit = (e) => {
        ...
        if (emailValidation(this.state.email)) {
            alert('message can be submitted')
        } else alert('please verify the email again and submit')
    }
    handleChange = (e) => {
            ...
            <section className='rounded p-4 contact-form'>
                ...
                <form onSubmit={this.handleSubmit}>
                    <div className='form-group'>
                        <input type='text' className='form-control' value={this.state.name} name='name' placeholder='Enter name...' />
                    </div>
                    <div className='form-group'>
                        <input type='email' className='form-control' value={this.state.email} name='email' placeholder='Enter Email...' />
                    </div>
                    <div className='form-group'>
                        <textarea type='text' className='form-control' value={this.state.message} name='message' placeholder='Enter Message...' />
                    </div>
